...
import {faChevronLeft, faChevronRight, faEllipsisH, faGlobe, faTimes, faPlay, faPause} from '@fortawesome/free-solid-svg-icons'

library.add(faChevronLeft, faChevronRight, faEllipsisH, faGlobe, faTimes, faPlay, faPause)
