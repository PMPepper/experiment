  ...
  return <div style={{padding: '10px'}}>
    ...
    <DataTable
      ...
      columns={[
        ...
        {name: 'memberType', label: 'Type', valueType: 'mapped', mappedTo: 'memberTypes', mappedValueType: 'string', sort: true},
      ]}
      rows={[
        ...
        {id: '9', data: {name: 'Kim', age: 40, joined: new Date(2017, 10, 10), memberType: '1'}},
        ...
        {id: '12', data: {name: 'John', age: 37, joined: new Date(2015, 10, 16), memberType: '1'}},
        ...
        {id: '23', data: {name: 'Jake', age: 66, joined: new Date(2018, 3, 9), memberType: '1'}},
        ...
        {id: '29', data: {name: 'Paul', age: 20, joined: new Date(2012, 6, 3), memberType: '1'}},
